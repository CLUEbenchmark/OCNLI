...
## added by kyle (check inside each file below and change path as needed)
# import modeling
# import optimization
# import tokenization
from ocnli.bert import modeling
from ocnli.bert import optimization
from ocnli.bert import tokenization
import tensorflow as tf
import logging
#import sys
#sys.path.append('..')
#from classifier_utils import *
from ocnli.classifier_utils import *
...
def main(_):
  ...
  # print(FLAGS.partial_input)
  # train_examples = processors["cmnli"]().get_arbitrary_examples(FLAGS.data_dir,None,
  ...
  if FLAGS.do_train:
    ...
    ## added by kyle
    logging.info("data_dir: %s" % FLAGS.data_dir)
